...
@section('filters')
    <form id="master_filter_form" class="mb-0" action="{{ route('activity.filter') }}" method="post">
        @csrf
        <div class="row">
            <div class="col-md-7"> <!-- Prima coppia di filtri -->
                ...
                <div class="row mb-1"> <!-- Riga selezione periodo -->
                    ...
                    <div class="col-md-8 col-lg-5">
                        <div class="d-flex">
                            ...
                            <button type="button" class="btn" onclick='$("#master_period_filter").val(""); $("#master_period_filter").change()'>
            ...
            <div class="col-md-5 ps-lg-5"> <!-- Seconda coppia di filtri -->
                ...
                <div class="row mb-1"> <!-- Riga selezione cliente -->
                    <label class="col-md-4 col-form-label ps-md-4 ps-lg-5" for="#master_costumer_filter">
                ...
                <div class="row"> <!-- Riga selezione stato -->
                    <label class="col-md-4 col-form-label ps-md-4 ps-lg-5" for="#master_state_filter">
                        @lang('labels.state')
                    </label>
                    <div class="col-md-8">
                        <div class="d-flex">
            ...
            <div> <!-- Riga per il submit della form dei filtri -->
                <div class="d-flex justify-content-center mt-3 pt-2 px-sm-2">
                    <div class="col col-md-4 col-lg-3">
                        <div class="d-flex">
                            <button class="btn btn-outline-secondary flex-grow-1" onclick="event.preventDefault(); save_filters()">
                                @lang('labels.filter')
                            </button>
                        </div>
                    </div>
...
@section('table_body')
    ...
    @foreach($activities as $activity)
        ...
        <tr>
            <td name="id" style="display: none">{{ $activity->id }}</td><!-- Serve a javascrit per il get dell'activity ID -->
            <td class="fw-bold" id="desc_{{ $activity->id }}" style="min-width: 230px">{{ $activity->descrizione_attivita }}</td>
            ...
            <td>
                @if($activity->rapportino_cliente && $activity->rapportino_commessa)
                    <a id="report_{{ $activity->id }}" class="btn pt-0" href="{{ route('activity.send_report', ['id' => $activity->id]) }}">
            ...
            <!--Bottone visualizza-->
            <td>
                <a id="show_{{ $activity->id }}" class="btn pt-0" href="{{ route('activity.show', ['activity' => $activity->id]) }}">
            ...
            <!--Bottone modifica-->
            <td>
                <a id="edit_{{ $activity->id }}" class="btn pt-0" href="{{ route('activity.edit', ['activity' => $activity->id]) }}">
            ...
            <!--Bottone elimina-->
            <td>
                <a id="delete_{{ $activity->id }}" class="btn pt-0" href="{{ route('activity.destroy.confirm', ['id' => $activity->id]) }}">
